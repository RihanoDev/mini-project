...
import (
	categories "api-mini-project/businesses/categories"
...
// CheckData provides a mock function with given fields: categoryDomain
func (_m *Repository) CheckData(categoryDomain *categories.Domain) categories.Domain {
